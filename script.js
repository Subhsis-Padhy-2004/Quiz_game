...
function questionCounter(index) {
    ...
    questionTotal.textContent = `${index} ରୁ ${questions.length} ପ୍ରଶ୍ନ`;
}

function headerScore() {
    const headerScoreText = document.querySelector('.header-score');
    headerScoreText.textContent = `ସ୍କୋର: ${userScore} / ${questions.length}`;
}
...
function showResultBox() {
    ...
    scoreText.textContent = `ଆପଣଙ୍କ ସ୍କୋର ${questions.length} ରୁ ${userScore}`;
